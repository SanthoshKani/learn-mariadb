...
/**
 * REST controller for managing {@link io.santhoshkani.learn.mariadb.domain.Country}.
 */
@RestController
...
public class CountryResource {
    ...
    public ResponseEntity<List<CountryDTO>> getAllCountries(
        ...
        Page<CountryDTO> page;
        if (eagerload) {
            page = countryService.findAllWithEagerRelationships(pageable);
        } else {
