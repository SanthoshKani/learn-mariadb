...
import io.santhoshkani.learn.mariadb.service.GuestService;
...
/**
 * REST controller for managing {@link io.santhoshkani.learn.mariadb.domain.Guest}.
 */
@RestController
...
public class GuestResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<GuestDTO>> getAllGuests(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
