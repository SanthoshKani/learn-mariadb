...
describe('Service Tests', () => {
  describe('Event Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Event(123, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Event', async () => {
        const returnedFromService = { name: 'BBBBBB', date: dayjs(currentDate).format(DATE_TIME_FORMAT), ...elemDefault };
      ...
      it('should partial update a Event', async () => {
        const patchObject = { name: 'BBBBBB', ...new Event() };
